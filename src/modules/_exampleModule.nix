# NOTE: Because this file name is prepended with an underscore, it will be ignored by import-tree.

# This is an example of a module following the dendritic pattern.
